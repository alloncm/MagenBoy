use crate::{apu::audio_device::AudioDevice, ppu::ppu_state::PpuState, utils::memory_registers::*};
...
pub fn update_mmu_registers<D:AudioDevice>(memory: &mut GbMmu<D>,dma:&mut OamDmaTransferer){
    ...
    let ports = memory.io_comps.ports.get_ports_cycle_trigger();
