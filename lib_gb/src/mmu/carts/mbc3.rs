...
impl Mbc for Mbc3 {
    ...
    fn read_current_bank(&self, address: u16) -> u8 {
        ...
        let internal_address: usize =
            (ROM_BANK_SIZE as usize * current_bank as usize) + address as usize;
        ...
        return match self.ram_rtc_select {
            0..=3 => {
                let internal_address =
                    self.ram_rtc_select as usize * RAM_BANK_SIZE as usize + address as usize;
