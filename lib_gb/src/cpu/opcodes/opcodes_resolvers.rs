use super::{
    arithmetic_16bit_instructions::*, arithmetic_8bit_instructions::*, cpu_control_instructions::*,
    jump_instructions::*, load_16bit_instructions::*, load_8bit_instructions::*,
    rotate_shift_instructions::*, single_bit_sintructions::*,
};
...
pub fn get_memory_opcode_func_2bytes_resolver<T: Memory>(
) -> fn(u8, u8) -> Option<MemoryOpcodeFunc<T>> {
...
pub fn get_u16_memory_opcode_func_resolver<T: Memory>(
) -> fn(u8, u8) -> Option<U16MemoryOpcodeFunc<T>> {
