use super::opcodes_utils::{
    check_for_half_carry_first_nible_add, check_for_half_carry_first_nible_sub, get_reg_two_rows,
    get_src_register,
};
...
fn add(cpu: &mut GbCpu, dest: u8, src: u8) -> u8 {
    ...
    cpu.set_by_value(
        Flag::HalfCarry,
        check_for_half_carry_first_nible_add(src, dest),
    );
...
fn adc(cpu: &mut GbCpu, dest: u8, src: u8) -> u8 {
    ...
    cpu.set_by_value(
        Flag::HalfCarry,
        check_for_half_carry_first_nible_add(dest, value_to_add) || half_carry_of,
    );
    cpu.unset_flag(Flag::Subtraction);
...
fn sub(cpu: &mut GbCpu, dest: u8, src: u8) -> u8 {
    ...
    cpu.set_by_value(
        Flag::HalfCarry,
        check_for_half_carry_first_nible_sub(dest, src),
    );
...
fn subc(cpu: &mut GbCpu, dest: u8, src: u8) -> u8 {
    ...
    cpu.set_by_value(
        Flag::HalfCarry,
        check_for_half_carry_first_nible_sub(dest, value_to_sub) || half_carry,
    );
    cpu.set_flag(Flag::Subtraction);
...
pub fn inc_r(cpu: &mut GbCpu, opcode: u8) -> u8 {
    ...
    cpu.set_by_value(
        Flag::HalfCarry,
        check_for_half_carry_first_nible_add(original_reg, 1),
    );
    cpu.unset_flag(Flag::Subtraction);
...
pub fn inc_hl(cpu: &mut GbCpu, memory: &mut impl Memory) -> u8 {
    ...
    cpu.set_by_value(
        Flag::HalfCarry,
        check_for_half_carry_first_nible_add(value, 1),
    );
    cpu.unset_flag(Flag::Subtraction);
...
pub fn dec_r(cpu: &mut GbCpu, opcode: u8) -> u8 {
    ...
    cpu.set_by_value(
        Flag::HalfCarry,
        check_for_half_carry_first_nible_sub(original_reg, finished_reg),
    );
    cpu.set_flag(Flag::Subtraction);
...
pub fn dec_hl(cpu: &mut GbCpu, memory: &mut impl Memory) -> u8 {
    ...
    cpu.set_by_value(
        Flag::HalfCarry,
        check_for_half_carry_first_nible_sub(value, altered_value),
    );
    cpu.set_flag(Flag::Subtraction);
