...
use crate::{apu::{audio_device::AudioDevice, gb_apu::GbApu}, keypad::joypad::Joypad, machine::Mode, ppu::{color::Color, ppu_state::PpuState}, utils::{bit_masks::{flip_bit_u8, BIT_7_MASK}, memory_registers::*}, FrameBuffer};
...
impl<'a, D:AudioDevice> GbMmu<'a, D>{
    ...
    pub fn set_joypad_state(&mut self, joypad: Joypad){
        self.io_bus.joypad_handler.set_joypad_state(joypad);
    }
