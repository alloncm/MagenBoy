...
use magenboy_common::interpolation::{scale_bilinear, scale_nearest};
...
criterion_group!(benches, interpolation_fir_bench, interpolation_rust_bench, neighbor_rust_inter);
