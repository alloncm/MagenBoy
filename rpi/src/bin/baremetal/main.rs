...
use magenboy_core::{machine::{gameboy::GameBoy, mbc_initializer::initialize_mbc, Mode}, utils::stack_string::StackString};
...
pub extern "C" fn main()->!{
    ...
    let mut gameboy = GameBoy::new_with_mode(mbc, joypad_provider, magenboy_rpi::BlankAudioDevice, gfx, Mode::CGB);
